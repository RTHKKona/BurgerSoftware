...
class MtArcToolApp:
    ...
    def run_batch_injection(self, original_dir: str, modified_base_dir: str, output_dir: str, log_callback: Callable[[str, str], None]):
        ...
        for i, arc_filepath in enumerate(arc_filepaths):
            ...
            modified_arc_folder = modified_base_path / arc_filename # Use filename without .arc
            ...
            if not modified_arc_folder.is_dir():
                log_callback(f"  [SKIP] Modified files folder not found: {modified_arc_folder} (expected name '{arc_filename}')", "WARN")
