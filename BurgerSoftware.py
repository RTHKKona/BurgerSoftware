...
_EXTENSION_MAP_RAW = {
    "rAIFSM": ".xfsa", "rCameraList": ".lcm", "rCharacter": ".xfsc",
    "rCollision": ".sbc", "rEffectAnim": ".ean", "rEffectList": ".efl",
    "rGUI": ".gui", "rGUIFont": ".gfd", "rGUIIconInfo": ".gii",
    "rGUIMessage": ".gmd", "rHit2D": ".xfsh", "rLayoutParameter": ".xfsl",
    "rMaterial": ".mrl", "rModel": ".mod", "rMotionList": ".lmt",
    "rPropParam": ".prp", "rScheduler": ".sdl", "rSoundBank": ".sbkr",
    "rSoundRequest": ".srqr", "rSoundSourceADPCM": ".mca", "rTexture": ".tex",
    "rBodyEdit": ".bed", "rEditConvert": ".edc", "rEffect2D": ".e2d",
    "rFaceEdit": ".fed", "rFacialAnimation": ".fca",
    0x22FA09: ".hpe", 0x26E7FF: ".ccl", 0x86B80F: ".plexp", 0xFDA99B: ".ntr",
    0x2358E1A: ".spkg", 0x2373BA7: ".spn", 0x2833703: ".efs", 0x315E81F: ".sds",
    0x437BCF2: ".grw", 0x4B4BE62: ".tmd", 0x525AEE2: ".wfp", 0x5A36D08: ".qif",
    0x69A1911: ".olp", 0x737E28B: ".rst", 0x7437CCE: ".base", 0x79B5F3E: ".pci",
    0x7F768AF: ".gii", 0x89BEF2C: ".sap", 0xA74682F: ".rnp", 0xC4FCAE4: ".PlDefendParam",
    0xD06BE6B: ".tmn", 0xECD7DF4: ".scs", 0x11C35522: ".gr2", 0x12191BA1: ".epv",
    0x12688D38: ".pjp", 0x12C3BFA7: ".cpl", 0x133917BA: ".mss", 0x14428EAE: ".gce",
    0x15302EF4: ".lot", 0x157388D3: ".itl", 0x15773620: ".nmr", 0x167DBBFF: ".stq",
    0x1823137D: ".mlm", 0x19054795: ".nnl", 0x199C56C0: ".ocl", 0x1B520B68: ".zon",
    0x1BCC4966: ".srq", 0x1C2B501F: ".atr", 0x1EB3767C: ".spr", 0x2052D67E: ".sn2",
    0x215896C2: ".statusparam", 0x2282360D: ".jex", 0x22948394: ".gui", 0x22B2A2A2: ".PlNeckPos",
    0x232E228C: ".rev", 0x241F5DEB: ".tex", 0x242BB29A: ".gmd", 0x257D2F7C: ".swm",
    0x2749C8A8: ".mrl", 0x271D08FE: ".ssq", 0x272B80EA: ".prp", 0x2A37242D: ".gpl",
    0x2A4F96A8: ".rbd", 0x2B0670A5: ".map", 0x2B303957: ".gop", 0x2B40AE8F: ".equ",
    0x2CE309AB: ".joblvl", 0x2D12E086: ".srd", 0x2D462600: ".gfd", 0x30FC745F: ".smx",
    0x312607A4: ".bll", 0x31B81AA5: ".qr", 0x325AACA5: ".shl", 0x32E2B13B: ".edp",
    0x33B21191: ".esp", 0x354284E7: ".lvl", 0x358012E8: ".vib", 0x39A0D1D6: ".sms",
    0x39C52040: ".lcm", 0x3A947AC1: ".cql", 0x3B350990: ".qsp", 0x3BBA4E33: ".qct",
    0x3D97AD80: ".amr", 0x3E356F93: ".stc", 0x3E363245: ".chn", 0x3FB52996: ".imx",
    0x4046F1E1: ".ajp", 0x437662FC: ".oml", 0x4509FA80: ".itemlv", 0x456B6180: ".cnsshake",
    0x472022DF: ".AIPlActParam", 0x48538FFD: ".ist", 0x48C0AF2D: ".msl", 0x49B5A885: ".ssc",
    0x4B704CC0: ".mia", 0x4C0DB839: ".sdl", 0x4CA26828: ".bmse", 0x4E397417: ".ean",
    0x4E44FB6D: ".fpe", 0x4EF19843: ".nav", 0x4FB35A95: ".aor", 0x50F3D713: ".skl",
    0x5175C242: ".geo2", 0x51FC779F: ".sbc", 0x522F7A3D: ".fcp", 0x52DBDCD6: ".rdd",
    0x535D969F: ".ctc", 0x5802B3FF: ".ahc", 0x58A15856: ".mod", 0x59D80140: ".ablparam",
    0x5A7FEA62: ".ik", 0x5B334013: ".bap", 0x5EA7A3E9: ".sky", 0x5F36B659: ".way",
    0x5F88B715: ".epd", 0x60BB6A09: ".hed", 0x6186627D: ".wep", 0x619D23DF: ".shp",
    0x628DFB41: ".gr2s", 0x63747AA7: ".rpi", 0x63B524A7: ".ltg", 0x64387FF1: ".qlv",
    0x65B275E5: ".sce", 0x66B45610: ".fsm", 0x671F21DA: ".stp", 0x69A5C538: ".dwm",
    0x6D0115ED: ".prt", 0x6D5AE854: ".efl", 0x6DB9FA5F: ".cmc", 0x6EE70EFF: ".pcf",
    0x6F302481: ".plw", 0x6FE1EA15: ".spl", 0x72821C38: ".stm", 0x73850D05: ".arc",
    0x754B82B4: ".ahs", 0x76820D81: ".lmt", 0x76DE35F6: ".rpn", 0x7808EA10: ".rtex",
    0x7817FFA5: ".fbik_human", 0x7AA81CAB: ".eap", 0x7BEC319A: ".sps", 0x7DA64808: ".qmk",
    0x7E1C8D43: ".pcs", 0x7E33A16C: ".spc", 0x7E4152FF: ".stg", 0x17A550D: ".lom",
    0x253F147: ".hit", 0x39D71F2: ".rvt", 0xDADAB62: ".oba", 0x10C460E6: ".msg",
    0x176C3F95: ".los", 0x19A59A91: ".lnk", 0x1BA81D3C: ".nck", 0x1ED12F1B: ".glp",
    0x1EFB1B67: ".adh", 0x2447D742: ".idm", 0x266E8A91: ".lku", 0x2C4666D1: ".smh",
    0x2DC54131: ".cdf", 0x30ED4060: ".pth", 0x36E29465: ".hkx", 0x38F66FC3: ".seg",
    0x430B4FF4: ".ptl", 0x46810940: ".egv", 0x4D894D5D: ".cmi", 0x4E2FEF36: ".mtg",
    0x4F16B7AB: ".hri", 0x50F9DB3E: ".bfx", 0x5204D557: ".shp", 0x538120DE: ".eng",
    0x557ECC08: ".aef", 0x585831AA: ".pos", 0x5898749C: ".bgm", 0x60524FBB: ".shw",
    0x60DD1B16: ".lsp", 0x758B2EB7: ".cef", 0x7D1530C2: ".sngw", 0x46FB08BA: ".bmt",
    0x285A13D9: ".vzo", 0x4323D83A: ".stex", 0x6A5CDD23: ".occ", 0x62440501: ".lmd",
    0x62A68441: ".thk", 0x4D3C70A1: ".bth", 0x244CC507: ".itr", 0x6A9197ED: ".sss",
    0x3B764DD4: ".sstr", 0x3516C3D2: ".lfd", 0x0CF7FB37: ".msf", 0x3D2E1661: ".ein",
    0x3B5A0DA5: ".idx", 0x354E1E08: ".ard", 0x5B9071CF: ".col", 0x342366F0: ".atk",
    0x76042FD2: ".eco", 0x052CCE4E: ".mef", 0x55E21D03: ".emp", 0x51BE0EC: ".rut",
    0x70078B5: ".rmt", 0x949A1DA: ".adl", 0x9C48A11: ".unk", 0xA736313: ".mdl",
    0x108F442E: ".mdl", 0x130124FA: ".rmh", 0x18FF29AB: ".cut", 0x1BE1DBEB: ".dom",
    0x24339E8C: ".evl", 0x28D65BFA: ".pos", 0x2ADFA358: ".pvl", 0x348C831D: ".evc",
    0x375F06DA: ".evt", 0x40171000: ".dat", 0x42940D09: ".fmt", 0x4356673E: ".man",
    0x46C78353: ".mes", 0x5DF3D947: ".mry", 0x5FF4BE71: ".ene", 0x6505B384: ".ddsp",
    0x681835FC: ".itm", 0x6A76E771: ".mes", 0x6B0369B1: ".atr", 0x6B571E45: ".lgt",
    0x6E69693A: ".obj", 0x7050198A: ".pmb", 0x74AFE18C: ".mdl", 0x7618CC9A: ".mtn",
    0x7D9D148B: ".eft", 0x7DB518E8: ".mdl", 0x7F68C6AF: ".mpac",
}
    ...
    def get_entry_data(self, entry: IMtEntryPy, compressed=False) -> bytes | None:
        if entry.data_to_write is not None:
            ...
            if entry.comp_size==0: is_zlib_compressed=False
                 ...
                 if is_zlib_compressed and not ((cmf_flg&0x0F00)>>8 == 8): self.log(f"Size mismatch header {cmf_flg:#04X} not Zlib: {entry.get_full_name()}", "WARN"); is_zlib_compressed=False
...
class HexEditorView(ttk.Frame):
    ...
    def __init__(self, parent, app_instance, is_popup=False):
        ...
        # --- Toolbar (Popout button or Apply button) ---
        self.hex_toolbar = ttk.Frame(self, style="Dark.TFrame")
        self.hex_toolbar.grid(row=0, column=0, columnspan=3, sticky=tk.EW, pady=(0, 5)) # Span across all cols
        ...
        self.addr_text = tk.Text(addr_frame, width=11, height=20, wrap=tk.NONE, state=tk.DISABLED, font=("Consolas", 9) if os.name == 'nt' else ("Monospace", 10), bg=WIDGET_BG, fg=HEX_ADDR_FG, relief=tk.FLAT, bd=0, cursor="arrow")
        ...
        self.hex_text = tk.Text(hex_frame, width=self.BYTES_PER_ROW * 3 + (self.BYTES_PER_ROW // self.BYTES_PER_GROUP), height=20, wrap=tk.NONE, font=("Consolas", 9) if os.name == 'nt' else ("Monospace", 10), undo=True, maxundo=50, bg=WIDGET_BG, fg=TEXT_COLOR, relief=tk.FLAT, bd=0, selectbackground=HIGHLIGHT_BG, selectforeground=HIGHLIGHT_FG, insertbackground=TEXT_COLOR)
        ...
        self.ascii_text = tk.Text(ascii_frame, width=self.BYTES_PER_ROW + 2, height=20, wrap=tk.NONE, undo=True, maxundo=50, font=("Consolas", 9) if os.name == 'nt' else ("Monospace", 10), bg=WIDGET_BG, fg=TEXT_COLOR, relief=tk.FLAT, bd=0, selectbackground=HIGHLIGHT_BG, selectforeground=HIGHLIGHT_FG, insertbackground=TEXT_COLOR)
        self.ascii_text['yscrollcommand'] = self._on_scroll; self.ascii_text.grid(row=0, column=0, sticky="nsew")

        self.hex_text.tag_configure("nullbyte", foreground=HEX_NULL_FG); self.ascii_text.tag_configure("nonprintable", foreground=ASCII_NONPRINT_FG)
    ...
    def _on_scroll(self, *args):
        if not self._syncing_scroll:
            self._syncing_scroll = True; self.hex_v_scroll.set(*args)
            fraction = float(args[0]) if len(args) == 1 else float(args[1])
    ...
    def load_data(self, entry, data: bytes):
        ...
        for i in range(0, len(data) if data else 0, self.BYTES_PER_ROW):
            ...
            for j in range(self.BYTES_PER_ROW):
                ...
                if j < len(chunk) and byte_val == 0: tags_hex.append(("nullbyte", col, col + 2))
                col += 2
    ...
    def handle_edit(self, source):
        ...
        if source == 'hex':
            ...
            for line_idx, line in enumerate(lines):
                hex_bytes_str = "".join(line.split()); byte_index_in_line = 0
        ...
        for i in range(0, len(self._raw_data), self.BYTES_PER_ROW):
            ...
            if view_to_update == 'hex':
                ...
                for j in range(self.BYTES_PER_ROW):
                    ...
                    if j < len(chunk) and byte_val == 0: tags.append(("nullbyte", col, col + 2))
                    col += 2
                    if (j + 1) % self.BYTES_PER_GROUP == 0 and j < self.BYTES_PER_ROW - 1: hex_row_parts.append(" "); col += 1
...
class MtArcToolApp:
    def __init__(self, root):
        ...
        self.menu_bar.add_cascade(label="File", menu=self.file_menu); root.config(menu=self.menu_bar); root.protocol("WM_DELETE_WINDOW", self.on_exit)
        ...
        self.tree_frame = ttk.Frame(self.main_h_pane, style="Dark.TFrame", padding="5"); self.main_h_pane.add(self.tree_frame, stretch="never", minsize=350)
        self.tree_frame.grid_rowconfigure(0, weight=1); self.tree_frame.grid_columnconfigure(0, weight=1)
        self.tree_scroll_y = ttk.Scrollbar(self.tree_frame, orient=tk.VERTICAL, style="Dark.Vertical.TScrollbar"); self.tree_scroll_x = ttk.Scrollbar(self.tree_frame, orient=tk.HORIZONTAL, style="Dark.Horizontal.TScrollbar")
        self.tree = ttk.Treeview(self.tree_frame, columns=("Size", "CompSize", "Offset"), show="tree headings", yscrollcommand=self.tree_scroll_y.set, xscrollcommand=self.tree_scroll_x.set, selectmode="browse", style="Dark.Treeview")
        ...
        log_scroll = ttk.Scrollbar(self.log_frame, orient=tk.VERTICAL, command=self.log_text.yview, style="Dark.Vertical.TScrollbar"); self.log_text['yscrollcommand'] = log_scroll.set; self.log_text.grid(row=0, column=0, sticky="nsew"); log_scroll.grid(row=0, column=1, sticky="ns")
        self.log_text.tag_configure("timestamp", foreground="gray"); self.log_text.tag_configure("info", foreground=TEXT_COLOR); self.log_text.tag_configure("debug", foreground="cyan"); self.log_text.tag_configure("print", foreground="lightblue"); self.log_text.tag_configure("warn", foreground="yellow"); self.log_text.tag_configure("error", foreground="orange"); self.log_text.tag_configure("fatal", foreground="red", font=(("Consolas", 9, "bold") if os.name == 'nt' else ("Monospace", 10, "bold")))
        self.button_frame = ttk.Frame(root, style="Dark.TFrame", padding=(5, 0, 5, 5)); self.button_frame.pack(fill=tk.X, side=tk.BOTTOM)
        self.extract_selected_btn = ttk.Button(self.button_frame, text="Extract Selected", command=self.extract_selected, state=tk.DISABLED, style="Dark.TButton"); self.extract_all_btn = ttk.Button(self.button_frame, text="Extract All", command=self.extract_all, state=tk.DISABLED, style="Dark.TButton"); self.add_files_btn = ttk.Button(self.button_frame, text="Add Files...", command=self.add_files, state=tk.DISABLED, style="Dark.TButton"); self.remove_selected_btn = ttk.Button(self.button_frame, text="Remove Selected", command=self.remove_selected, state=tk.DISABLED, style="Dark.TButton"); self.replace_selected_btn = ttk.Button(self.button_frame, text="Replace Selected...", command=self.replace_selected, state=tk.DISABLED, style="Dark.TButton")
        self.extract_selected_btn.pack(side=tk.LEFT, padx=5, pady=5); self.extract_all_btn.pack(side=tk.LEFT, padx=5, pady=5); self.add_files_btn.pack(side=tk.LEFT, padx=5, pady=5); self.remove_selected_btn.pack(side=tk.LEFT, padx=5, pady=5); self.replace_selected_btn.pack(side=tk.LEFT, padx=5, pady=5)
        ...
        self.redirect_print(); self.arc.set_logger(self.log_message); self.set_status("Ready. Open an ARC file."); self.log_message("MT ARC Tool started.", level="INFO"); self.update_button_states()
    ...
    def setup_styles(self):
        ...
        style.configure("Dark.Treeview", background=WIDGET_BG, foreground=TEXT_COLOR, fieldbackground=WIDGET_BG, rowheight=22); style.map("Dark.Treeview", background=[('selected',HIGHLIGHT_BG)], foreground=[('selected',HIGHLIGHT_FG)])
        style.configure("Dark.Treeview.Heading", background=HEADER_BG, foreground=HEADER_FG, relief=tk.RAISED, padding=(5,3)); style.map("Dark.Treeview.Heading", background=[('active',HIGHLIGHT_BG)])
    ...
    def mark_dirty(self, dirty=True):
        ...
        if dirty == self.is_dirty: return; self.is_dirty = dirty; title = "MT ARC Tool";
    ...
    def update_button_states(self):
        ...
        if has_selection:
             ...
             except tk.TclError: tags = () # Handle case where item disappears
